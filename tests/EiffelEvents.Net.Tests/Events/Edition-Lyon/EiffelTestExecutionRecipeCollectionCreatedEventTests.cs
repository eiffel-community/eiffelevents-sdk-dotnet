...
{
    public class EiffelTestExecutionRecipeCollectionCreatedEventTests : IClassFixture<EiffelTestExecutionRecipeCollectionCreatedEventFixture>
    {
        private readonly EiffelTestExecutionRecipeCollectionCreatedEventFixture _eventFixture;

        public EiffelTestExecutionRecipeCollectionCreatedEventTests(EiffelTestExecutionRecipeCollectionCreatedEventFixture eventFixture)
        {
        ...
        public void VerifySignature_ValidSignature_Success()
        {
            ...
            //Act
            var testExecutionRecipeCollectionCreatedEventSigned = testExecutionRecipeCollectionCreatedEvent.Sign<EiffelTestExecutionRecipeCollectionCreatedEvent>();
