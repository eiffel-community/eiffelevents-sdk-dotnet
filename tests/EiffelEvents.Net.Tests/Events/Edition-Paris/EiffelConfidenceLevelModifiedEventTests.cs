...
namespace EiffelEvents.Net.Tests.Events.Edition_Paris
{
    ...
    {
        private EiffelConfidenceLevelModifiedEventFixture _eventFixture;

        public EiffelConfidenceLevelModifiedEventTests(EiffelConfidenceLevelModifiedEventFixture fixture)
        {
