...
{
    public class EiffelTestCaseTriggeredEventFixture
    {
        /// <summary>
        /// Get a complete valid instance of EiffelTestCaseTriggeredEvent.
        /// </summary>
        /// <returns></returns>
        public EiffelTestCaseTriggeredEvent GetValidCompleteEvent()
        {
            return new EiffelTestCaseTriggeredEvent
            {
                Data = new()
                {
                    TestCase = new ()
