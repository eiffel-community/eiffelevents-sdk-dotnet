...
{
    public class TestExecutionRecipeCollectionCreated
    {
        public static EiffelTestExecutionRecipeCollectionCreatedEvent GetEvent()
        {
            return new EiffelTestExecutionRecipeCollectionCreatedEvent
            {
                ...
                Links = new()
                {
                    Context = "aaaaaaaa-bbbb-5ccc-8ddd-eeeeeeeeeee1"
                }
            };
        }
    }
