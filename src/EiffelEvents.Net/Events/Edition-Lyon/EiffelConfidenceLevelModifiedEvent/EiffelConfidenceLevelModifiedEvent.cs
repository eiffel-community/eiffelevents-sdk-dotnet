...
{
    /// <summary>
    /// The <a href="https://github.com/eiffel-community/eiffel/blob/edition-lyon/eiffel-vocabulary/EiffelConfidenceLevelModifiedEvent.md">
    /// EiffelConfidenceLevelModifiedEvent</a> declares that an entity has achieved (or failed to achieve) a certain level of confidence,
    ...
    public record EiffelConfidenceLevelModifiedEvent
        : EiffelEvent<EiffelConfidenceLevelModifiedData, EiffelConfidenceLevelModifiedMeta, EiffelConfidenceLevelModifiedLinks>
    {
        /// <inheritdoc/>
