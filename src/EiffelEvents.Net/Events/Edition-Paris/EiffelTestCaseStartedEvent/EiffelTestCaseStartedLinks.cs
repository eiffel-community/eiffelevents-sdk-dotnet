...
namespace EiffelEvents.Net.Events.Edition_Paris
{
    ...
    {
        /// <summary>
        /// Identifies the relevant test case execution. In other words, EiffelTestCaseTriggeredEvent acts as
        /// a handle for a particular test case execution. This differs from CONTEXT.
        /// In TEST_CASE_EXECUTION the source carries information pertaining to the target
        /// (i.e. the test case execution started, finished or was canceled). In CONTEXT, on the other hand,
        /// the source constitutes a subset of the target (e.g. this test case was executed as part of that activity or
        /// test suite).
