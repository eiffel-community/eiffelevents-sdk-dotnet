...
namespace EiffelEvents.Net.Events.Edition_Paris
{
    public record EiffelTestSuiteStartedLinks : EiffelSharedLinks
    {
        ...
        /// from the <see cref="EiffelTestExecutionRecipeCollectionCreatedEvent"/>
        /// Legal target: EiffelTestExecutionRecipeCollectionCreatedEvent
        /// </summary>
        [ValidGuid]
        public string Terc { get; init; }
    }
}