...
{
    public record EiffelTestCaseFinishedLinks : EiffelSharedLinks
    {
        /// <summary>
        ...
        /// the source constitutes a subset of the target (e.g. this test case was executed as part of that activity
        /// or test suite).
